...
describe CampaignsController do
  ...
  it "creates campaign" do
    expect {
      post campaigns_url, params: { campaign: { description: campaign.description, name: campaign.name, player_id_id: campaign.player_id_id } }
  ...
  it "updates campaign" do
    patch campaign_url(campaign), params: { campaign: { description: campaign.description, name: campaign.name, player_id_id: campaign.player_id_id } }
